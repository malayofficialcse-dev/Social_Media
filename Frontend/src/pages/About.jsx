    ...
    <div className="py-16 relative overflow-hidden">
      ...
      <div className="px-6">
        ...
        >
          {team.map((member, index) => (
            ...
            >
              <div className="relative bg-surface/40 backdrop-blur-2xl border border-border-main rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(6,182,212,0.15)] group-hover:bg-surface/60">
                {/* Image Wrap */}
                <div className="p-4">
                  <div className="aspect-[4/5] rounded-[2rem] overflow-hidden relative shadow-inner">
                    ...
                    />
                    {/* Overlay Socials */}
                    <div className="absolute inset-0 bg-gradient-to-t from-surface/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-end justify-center pb-8 translate-y-4 group-hover:translate-y-0">
                      <div className="flex gap-4 p-3 bg-card/40 backdrop-blur-md rounded-2xl border border-border-main">
                        <a href={member.socials.github} className="p-2 text-text-main hover:text-accent transition-colors"><FaGithub size={22} /></a>
                        <a href={member.socials.linkedin} className="p-2 text-text-main hover:text-accent transition-colors"><FaLinkedin size={22} /></a>
                        <a href={member.socials.twitter} className="p-2 text-text-main hover:text-accent transition-colors"><FaTwitter size={22} /></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="px-8 pb-10 pt-2 text-center">
                  <h3 className="text-2xl font-bold text-text-main mb-2 transition-colors group-hover:text-accent">
                    {member.name}
                  </h3>
      ...
      >
        {[
          ...
          <div key={i} className="p-8 bg-surface/40 backdrop-blur-sm border border-border-main rounded-3xl hover:bg-surface/60 transition-colors">
      ...
      >
        ...
        <h2 className="text-4xl font-bold text-text-main mb-8">Ready to Connect?</h2>
        <motion.button
